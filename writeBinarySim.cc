...
///////////////////////////////////////////write binary file
void writeBinaryForReco(char *OutputFileDir,int ProjAngle,char *InputNameFile,float v_strips[4][15000000],float t_strips[4][15000000],float energy[15000000][5],int GoodEventCounter)
{
