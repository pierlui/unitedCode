...
/////////////////////////////////////////// Prepare stuff for WEPL calibration 	
	...
	sprintf(CalibFile,"%s/calib.txt",OutputFileDir); 
...
//double ped[5] = {121.3, -71.5, -1137, 346.2, -49.}; // predefined pedestal values JULY
double ped[5] = {431,-130,-20,224,60}; //SEPTEMBER
